...
import com.bwie.test.monthexamabone.adapters.MyGridView;
import com.bwie.test.monthexamabone.adapters.OtherAdapter;
...
public class Fragment2 extends Fragment implements OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = View.inflate(getActivity(), R.layout.fragment2_layout,null);
        return view;
    }
    ...
    public void initView() {
        mUserGv = (MyGridView) view.findViewById(R.id.userGridView);
        mOtherGv = (MyGridView) view.findViewById(R.id.otherGridView);
        mUserList.add("推荐");
        mUserList.add("热点");
        mUserList.add("上海");
        mUserList.add("时尚");
        ...
        mOtherList.add("娱乐");
        mOtherList.add("探索");
        mUserAdapter = new OtherAdapter(getActivity(), mUserList,true);
        mOtherAdapter = new OtherAdapter(getActivity(), mOtherList,false);
